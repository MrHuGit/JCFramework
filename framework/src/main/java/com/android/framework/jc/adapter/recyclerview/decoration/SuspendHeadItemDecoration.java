//package com.android.framework.jc.adapter.recyclerview.decoration;
//
...
//
///**
// * @author Mr.Hu(Jc) ExxAndroid
// * @create 2018/9/5 13:38
// * @describe
// * @update
// */
//public class SuspendHeadItemDecoration extends RecyclerView.ItemDecoration implements ISuspendHeaderDecoration{
//
...
//        if (parent.getAdapter() instanceof SuspendRvAdapter && parent.getChildCount() > 0) {
//            SuspendRvAdapter adapter = (SuspendRvAdapter) parent.getAdapter();
//            //找到要固定的pin view
...
//                adapter.onBindViewHolder(adapter.onCreateViewHolder(parent,
//                        adapter.getItemViewType(pinnedHeaderPosition)), pinnedHeaderPosition);
//                //要固定的view
...
//     * @return -1：未找到 >=0 找到位置
//     */
//    private int getPinnedHeaderViewPosition(int adapterFirstVisible, SuspendRvAdapter adapter) {
...
//    }
//    @Override
//    public Rect getSuspendHeaderRect() {
//        return mPinnedHeaderRect;
//    }
//
//    @Override
//    public int getSuspendHeaderPosition() {
