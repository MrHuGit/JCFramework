package com.android.framework_test.screen;
 ...
 * @create 2019/5/17 16:30
 * @describe 截屏判断依据: 监听媒体数据库的数据改变, 在有数据改变时获取最后插入数据库的一条图片数据, 如果符合以下规则, 则认为截屏了:
...
//        }
    ...
    public void startListen(Context context) {
        ...
        // 创建内容观察者
        mInternalObserver = new MediaContentObserver(MediaStore.Images.Media.INTERNAL_CONTENT_URI, mUiHandler,context);
        mExternalObserver = new MediaContentObserver(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, mUiHandler,context);
...
//            if (Builder.VERSION.SDK_INT >= Builder.VERSION_CODES.JELLY_BEAN_MR1) {
...
//    }
    ...
    private class MediaContentObserver extends ContentObserver {
         ...
         * 处理媒体数据库的内容改变
         */
        private void handleMediaContentChange() {
            Cursor cursor = null;
            try {
